...
function HomeManagement() {
  ...
  useEffect(() => {
    ...
    if (currentUserTemp?.rights.includes('READ_BUG_REPORTS') || currentUserTemp?.rights.includes('ADMIN')) {
    ...
    if (currentUserTemp?.rights.includes('READ_CONTACT_REQUESTS') || currentUserTemp?.rights.includes('ADMIN')) {
    ...
    if (currentUserTemp?.rights.includes('READ_POST_REPORTS') || currentUserTemp?.rights.includes('ADMIN')) {
    ...
    if ((currentUserTemp?.rights.includes('READ_POST_REPORTS') && currentUserTemp?.rights.includes('READ_CONTACT_REQUESTS') && currentUserTemp?.rights.includes('READ_BUG_REPORTS')) || currentUserTemp?.rights.includes('ADMIN')) {
      setBaseSize(4)
      setBugSize(4)
      setContactSize(4)
      setReportSize(4)
